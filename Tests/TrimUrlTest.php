...
namespace Prokl\CustomRequestResponserBundle\Tests;

use Prokl\CustomRequestResponserBundle\Services\PageSpeed\InsertDNSPrefetch;
use Prokl\CustomRequestResponserBundle\Services\PageSpeed\TrimUrl;

/**
 * Class TrimUrlTest
 * @package Prokl\CustomRequestResponserBundle\Tests
 *
 * @since 21.02.2021
 */
